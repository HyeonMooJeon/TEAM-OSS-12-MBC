...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private int port = 8846;
    private final String ip = "192.168.0.38";
    /*
                ...
                Thread worker = new Thread() {    //worker 를 Thread 로 생성
                    public void run() { //스레드 실행구문
                        try {
                            ...
                            socket = new Socket("192.168.0.38", 8846); //소켓생성
        ...
        builder.setPositiveButton("설정", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                Intent callGPSSettingIntent
                        = new Intent(android.provider.Settings.ACTION_LOCATION_SOURCE_SETTINGS); //위치서비스 활성화
