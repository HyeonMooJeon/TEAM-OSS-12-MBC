...
/**
 * Created by Admin_PC on 1/30/2017.
 */

public class DrawingViewtwo extends ImageView implements View.OnTouchListener
{
    //Cut
    private Paint paint;
    ...
    public DrawingViewtwo(Context c)
    {
        super(c);
        mContext = c;
        setFocusable(true);
    ...
    public DrawingViewtwo(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        mContext = context;
        setFocusable(true);
            ...
            if (flgPathDraw)
            {
                if (bfirstpoint)
                {
                    if (comparepoint(mfirstpoint, point))
                    {
                        ...
                        Intent intent = new Intent(mContext, EditPicturethreeActivity.class);
                        mContext.startActivity(intent);

                        instance.common_flagzero = true;
