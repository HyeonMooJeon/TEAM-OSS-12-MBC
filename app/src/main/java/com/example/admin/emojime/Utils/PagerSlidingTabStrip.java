...
import com.example.admin.emojime.PhoneScaleApplication;
...
public class PagerSlidingTabStrip extends HorizontalScrollView
{
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        defaultTabLayoutParams = new LinearLayout.LayoutParams(PhoneScaleApplication.phone_width / 4, LayoutParams.MATCH_PARENT);
